...
class Server(object):
    ...
    def __init__(self, model_config={}, global_config={}, data_config={}, init_config={}, fed_config={}, optim_config={}):
        ...
        self.shard_size = data_config["shard_size"]
    ...
    def setup(self, **init_kwargs):
        ...
        local_datasets, test_dataset = create_datasets(self.data_path, self.dataset_name, self.num_clients, self.num_shards, self.shard_size, self.num_class, self.contained_num_class, self.iid)
    ...
    def random_selection(self):
        num_sampled_clients = np.random.choice([1, 2], p=[0.6, 0.4], replace=False)
    ...
    def average_selected_client_model(self):
        ...
        count = 0
        fl = open('/home/narisu/src/omnet/omnetpp-5.5.1/samples/toyota_FLwithTensorflow/examples/federatedlearning/wholeCode/FL.txt', 'a')
    ...
    def train_federated_model(self, selected_clients):
        """Do federated training."""
        # select pre-defined fraction of clients randomly
        # sampled_client_indices = self.sample_clients()
        sampled_client_indices = selected_clients[self._round - 1]
    ...
    def fit(self):
        ...
        self.num_rounds = 6
        selected_client_list = [[5, 6], [7, 8], [9], [6], [0, 1], [2, 3]]
        for r in range(self.num_rounds):
            self._round = r + 1
            
            self.train_federated_model(selected_client_list)
            ...
            message = f"\t[Server] Loss: {test_loss:.4f}, Accuracy: {100. * test_accuracy:.2f}%"
            print(message); logging.info(message)
            del message; gc.collect()
        self.transmit_model()
