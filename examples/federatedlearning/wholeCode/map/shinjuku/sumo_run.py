...
while traci.simulation.getMinExpectedNumber() > 0:
        ...
        for i in range(0,len(vehicles)):
                ...
                gpscoord = [lon, lat]
                spd = round(traci.vehicle.getSpeed(vehicles[i])*3.6,2)  # m/s to km/h conversion and rounding to 2
                ...
                nextTLS = traci.vehicle.getNextTLS(vehicles[i])     #list of upcoming traffic lights
                ...
                #NEWSPEED1 = 13.8889 # value in m/s (13.8889 m/s = 50 km/hr)
                #NEWSPEED2 = 20.8333 # value in m/s (20.8333 m/s = 75 km/hr)               
                #NEWSPEED3 = 27.7778 # value in m/s (27.7778 m/s = 100 km/hr)  

                #NEWSPEED1 = 2.77778 # value in m/s (13.8889 m/s = 10.8 km/hr)
                #NEWSPEED2 = 27.7778 # value in m/s (20.8333 m/s = 100 km/hr)               
                #NEWSPEED3 = 2.77778 # value in m/s (27.7778 m/s = 10.8 km/hr)  

                #if timestep == 30:
                #    if vehicles[i]=='veh1':
#
#                            traci.vehicle.setSpeedMode('veh1',0)
#                            traci.vehicle.setSpeed('veh1',NEWSPEED1)
                            
                            
#                if timestep == 50:
#                    if vehicles[i]=='veh1':
#                        traci.vehicle.setSpeedMode('veh1',0)
#                        traci.vehicle.setSpeed('veh1',NEWSPEED2)                                    
                                    
#                if timestep == 75:
#                    if vehicles[i]=='veh1':
#                        traci.vehicle.setSpeedMode('veh1',0)
#                        traci.vehicle.setSpeed('veh1',NEWSPEED3)                        
