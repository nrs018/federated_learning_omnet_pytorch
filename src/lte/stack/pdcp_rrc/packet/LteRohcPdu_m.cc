...
int LteRohcPduDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'o' && strcmp(fieldName, "origSizeTransportHeader") == 0) return base+0;
    if (fieldName[0] == 'o' && strcmp(fieldName, "origSizeIpHeader") == 0) return base+1;
...
int LteRohcPduDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteRohcPdu *pp = (LteRohcPdu *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *LteRohcPduDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string LteRohcPduDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool LteRohcPduDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteRohcPdu *pp = (LteRohcPdu *)object; (void)pp;
    switch (field) {
        case FIELD_origSizeTransportHeader: pp->setOrigSizeTransportHeader(B(string2long(value))); return true;
        case FIELD_origSizeIpHeader: pp->setOrigSizeIpHeader(B(string2long(value))); return true;
...
void *LteRohcPduDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
