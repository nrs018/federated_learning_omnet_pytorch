...
bool LteSchedulingGrantDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    LteSchedulingGrant_Base *pp = (LteSchedulingGrant_Base *)object; (void)pp;
    switch (field) {
        case FIELD_periodic: pp->setPeriodic(string2bool(value)); return true;
        case FIELD_period: pp->setPeriod(string2ulong(value)); return true;
        case FIELD_expiration: pp->setExpiration(string2ulong(value)); return true;
        case FIELD_totalGrantedBlocks: pp->setTotalGrantedBlocks(string2ulong(value)); return true;
        case FIELD_codewords: pp->setCodewords(string2ulong(value)); return true;
        case FIELD_grantedCwBytes: pp->setGrantedCwBytes(i,string2ulong(value)); return true;
