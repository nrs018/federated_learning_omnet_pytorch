...
int LteRlcPduDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    LteRlcPdu *pp = (LteRlcPdu *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
bool LteRlcPduDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    LteRlcPdu *pp = (LteRlcPdu *)object; (void)pp;
    switch (field) {
        case FIELD_totalFragments: pp->setTotalFragments(string2ulong(value)); return true;
        case FIELD_snoFragment: pp->setSnoFragment(string2ulong(value)); return true;
        case FIELD_snoMainPacket: pp->setSnoMainPacket(string2ulong(value)); return true;
...
int LteRlcPduNewDataDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LteRlcPduNewData *pp = (LteRlcPduNewData *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *LteRlcPduNewDataDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string LteRlcPduNewDataDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool LteRlcPduNewDataDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *LteRlcPduNewDataDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
