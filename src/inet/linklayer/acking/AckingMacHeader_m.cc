//
// Generated file, do not edit! Created by nedtool 5.5 from inet/linklayer/acking/AckingMacHeader.msg.
//
...
int AckingMacHeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'n' && strcmp(fieldName, "networkProtocol") == 0) return base+3;
...
int AckingMacHeaderDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    AckingMacHeader *pp = (AckingMacHeader *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *AckingMacHeaderDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string AckingMacHeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool AckingMacHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    AckingMacHeader *pp = (AckingMacHeader *)object; (void)pp;
    switch (field) {
        case FIELD_srcModuleId: pp->setSrcModuleId(string2long(value)); return true;
...
void *AckingMacHeaderDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
