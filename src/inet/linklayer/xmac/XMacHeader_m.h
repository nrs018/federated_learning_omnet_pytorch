...
/**
 * Enum generated from <tt>inet/linklayer/xmac/XMacHeader.msg:25</tt> by nedtool.
 * <pre>
...
class INET_API XMacHeaderBase : public ::inet::FieldsChunk
{
  ...
  protected:
    ...
    bool operator==(const XMacHeaderBase&);
...
/**
 * Class generated from <tt>inet/linklayer/xmac/XMacHeader.msg:62</tt> by nedtool.
 * <pre>
 * //
...
class INET_API XMacControlFrame : public ::inet::XMacHeaderBase
{
  ...
  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const XMacControlFrame&);
...
/**
 * Class generated from <tt>inet/linklayer/xmac/XMacHeader.msg:70</tt> by nedtool.
 * <pre>
 * //
...
class INET_API XMacDataFrameHeader : public ::inet::XMacHeaderBase
{
  ...
  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const XMacDataFrameHeader&);
