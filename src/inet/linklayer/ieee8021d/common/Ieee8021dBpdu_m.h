...
/**
 * Enum generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:22</tt> by nedtool.
 * <pre>
...
/**
 * Enum generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:26</tt> by nedtool.
 * <pre>
...
/**
 * Enum generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:32</tt> by nedtool.
 * <pre>
 * enum BpduType
 * {
 *     BPDU_CFG = 0;
...
/**
 * Class generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:43</tt> by nedtool.
 * <pre>
 * //
...
{
  protected:
    inet::BpduProtocolIdentifier protocolIdentifier = static_cast<BpduProtocolIdentifier>(-1);
    inet::BpduProtocolVersionIdentifier protocolVersionIdentifier = static_cast<BpduProtocolVersionIdentifier>(-1);
    inet::BpduType bpduType = static_cast<BpduType>(-1);
  ...
  public:
    ...
    virtual inet::BpduProtocolIdentifier getProtocolIdentifier() const;
    virtual void setProtocolIdentifier(inet::BpduProtocolIdentifier protocolIdentifier);
    virtual inet::BpduProtocolVersionIdentifier getProtocolVersionIdentifier() const;
    virtual void setProtocolVersionIdentifier(inet::BpduProtocolVersionIdentifier protocolVersionIdentifier);
    virtual inet::BpduType getBpduType() const;
    virtual void setBpduType(inet::BpduType bpduType);
};
...
/**
 * Class generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:50</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/linklayer/ieee8021d/common/Ieee8021dBpdu.msg:58</tt> by nedtool.
 * <pre>
