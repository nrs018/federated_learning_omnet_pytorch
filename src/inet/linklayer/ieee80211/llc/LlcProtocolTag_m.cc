//
// Generated file, do not edit! Created by nedtool 5.5 from inet/linklayer/ieee80211/llc/LlcProtocolTag.msg.
//
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::ieee80211::LlcProtocolId");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::ieee80211::LlcProtocolId"));
    e->insert(LPD, "LPD");
    e->insert(EPD, "EPD");
)
...
int LlcProtocolTagDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'p' && strcmp(fieldName, "protocolId") == 0) return base+0;
...
int LlcProtocolTagDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LlcProtocolTag *pp = (LlcProtocolTag *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *LlcProtocolTagDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string LlcProtocolTagDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool LlcProtocolTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LlcProtocolTag *pp = (LlcProtocolTag *)object; (void)pp;
    switch (field) {
        case FIELD_protocolId: pp->setProtocolId((inet::ieee80211::LlcProtocolId)string2enum(value, "inet::ieee80211::LlcProtocolId")); return true;
...
void *LlcProtocolTagDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
