//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/mpls/MplsPacket.msg.
//
...
bool MplsHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_tc: pp->setTc(string2ulong(value)); return true;
        case FIELD_s: pp->setS(string2bool(value)); return true;
        case FIELD_ttl: pp->setTtl(string2ulong(value)); return true;
