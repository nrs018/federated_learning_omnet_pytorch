//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/arp/ipv4/ArpPacket.msg.
//
...
inet::ArpOpcode ArpPacket::getOpcode() const
{
    return this->opcode;
}

void ArpPacket::setOpcode(inet::ArpOpcode opcode)
{
    handleChange();
    this->opcode = opcode;
}
...
void *ArpPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_srcIpAddress: return toVoidPtr(&pp->getSrcIpAddress()); break;
        case FIELD_destIpAddress: return toVoidPtr(&pp->getDestIpAddress()); break;
        default: return nullptr;
    }
}
