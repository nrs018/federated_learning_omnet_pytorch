//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/ipv4/Ipv4Header.msg.
//
...
int Ipv4HeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 't' && strcmp(fieldName, "typeOfService") == 0) return base+2;
    if (fieldName[0] == 't' && strcmp(fieldName, "totalLengthField") == 0) return base+3;
    if (fieldName[0] == 'i' && strcmp(fieldName, "identification") == 0) return base+4;
    if (fieldName[0] == 'r' && strcmp(fieldName, "reservedBit") == 0) return base+5;
    if (fieldName[0] == 'm' && strcmp(fieldName, "moreFragments") == 0) return base+6;
    if (fieldName[0] == 'd' && strcmp(fieldName, "dontFragment") == 0) return base+7;
    if (fieldName[0] == 'f' && strcmp(fieldName, "fragmentOffset") == 0) return base+8;
    if (fieldName[0] == 't' && strcmp(fieldName, "timeToLive") == 0) return base+9;
    if (fieldName[0] == 'p' && strcmp(fieldName, "protocolId") == 0) return base+10;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crc") == 0) return base+11;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crcMode") == 0) return base+12;
    if (fieldName[0] == 's' && strcmp(fieldName, "srcAddress") == 0) return base+13;
    if (fieldName[0] == 'd' && strcmp(fieldName, "destAddress") == 0) return base+14;
