//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/rsvpte/RsvpPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::RsvpConstants");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::RsvpConstants"));
    e->insert(PATH_MESSAGE, "PATH_MESSAGE");
    e->insert(RESV_MESSAGE, "RESV_MESSAGE");
    e->insert(PTEAR_MESSAGE, "PTEAR_MESSAGE");
    e->insert(RTEAR_MESSAGE, "RTEAR_MESSAGE");
    e->insert(PERROR_MESSAGE, "PERROR_MESSAGE");
    e->insert(RERROR_MESSAGE, "RERROR_MESSAGE");
    e->insert(HELLO_MESSAGE, "HELLO_MESSAGE");
)
...
bool RsvpMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    RsvpMessage *pp = (RsvpMessage *)object; (void)pp;
    switch (field) {
        case FIELD_rsvpKind: pp->setRsvpKind(string2long(value)); return true;
...
int RsvpPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    RsvpPacket *pp = (RsvpPacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
bool RsvpPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    RsvpPacket *pp = (RsvpPacket *)object; (void)pp;
    switch (field) {
        case FIELD_checksumValid: pp->setChecksumValid(string2bool(value)); return true;
        default: return false;
    }
}
