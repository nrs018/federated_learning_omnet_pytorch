//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/ted/LinkStatePacket.msg.
//
...
{
    if (k >= linkInfo_arraysize) throw omnetpp::cRuntimeError("Array of size linkInfo_arraysize indexed by %lu", (unsigned long)k);
...
{
    if (k >= linkInfo_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
    handleChange();
...
void LinkStateMsg::insertLinkInfo(const TeLinkStateInfo& linkInfo)
{
...
unsigned int LinkStateMsgDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISARRAY | FD_ISCOMPOUND,    // FIELD_linkInfo
...
std::string LinkStateMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    LinkStateMsg *pp = (LinkStateMsg *)object; (void)pp;
    switch (field) {
        case FIELD_linkInfo: {std::stringstream out; out << pp->getLinkInfo(i); return out.str();}
...
void *LinkStateMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    LinkStateMsg *pp = (LinkStateMsg *)object; (void)pp;
    switch (field) {
        case FIELD_linkInfo: return toVoidPtr(&pp->getLinkInfo(i)); break;
        default: return nullptr;
    }
}
