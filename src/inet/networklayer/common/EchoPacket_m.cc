//
// Generated file, do not edit! Created by nedtool 5.5 from inet/networklayer/common/EchoPacket.msg.
//
...
inet::EchoProtocolType EchoPacket::getType() const
{
    return this->type;
}

void EchoPacket::setType(inet::EchoProtocolType type)
{
    handleChange();
    this->type = type;
}
