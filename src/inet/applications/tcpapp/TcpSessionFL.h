...
//
#ifndef __INET_TCPSESSIONFL_H
#define __INET_TCPSESSIONFL_H
 ...
 */
class INET_API TcpSessionFL : public TcpAppBase
{
  protected:
    // parameters
    struct Command
  ...
  public:
    TcpSessionFL() {}
    virtual ~TcpSessionFL();
};

} // namespace inet

#endif // ifndef __INET_TCPSESSIONFL_H
