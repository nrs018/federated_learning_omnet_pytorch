...
#ifndef __INET_TCPSINKFL_H
#define __INET_TCPSINKFL_H
 ...
 * on them.
 */
class INET_API TcpSinkFL : public TcpServerHostApp
{
  protected:
    long bytesRcvd = 0;
  ...
  public:
    ...
    friend class TcpSinkFLThread;
};

class INET_API TcpSinkFLThread : public TcpServerThreadBase
{
  protected:
    long bytesRcvd;
    TcpSinkFL *sinkAppModule = nullptr;
    ...
    virtual void init(TcpServerHostApp *hostmodule, TcpSocket *socket) override {
        ...
        sinkAppModule = check_and_cast<TcpSinkFL *>(hostmod);
    }
  public :
    bool flagpos = true;
...
#endif // ifndef __INET_TCPSINKFL_H
