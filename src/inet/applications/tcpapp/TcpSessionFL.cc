...
#include "inet/applications/tcpapp/TcpSessionFL.h"
...
TcpSessionFL::~TcpSessionFL()
{
    cancelAndDelete(timeoutMsg);
}

void TcpSessionFL::initialize(int stage)
{
...
void TcpSessionFL::handleStartOperation(LifecycleOperation *operation)
{
    if (simTime() <= tOpen) {
...
void TcpSessionFL::handleStopOperation(LifecycleOperation *operation)
{
...
void TcpSessionFL::handleCrashOperation(LifecycleOperation *operation)
{
    cancelEvent(timeoutMsg);
...
void TcpSessionFL::handleTimer(cMessage *msg)
{
    switch (msg->getKind()) {
...
Packet *TcpSessionFL::createDataPacket(long sendBytes)
{
...
void TcpSessionFL::socketEstablished(TcpSocket *socket)
{
...
void TcpSessionFL::socketDataArrived(TcpSocket *socket, Packet *msg, bool urgent)
{
    TcpAppBase::socketDataArrived(socket, msg, urgent);
}

void TcpSessionFL::socketClosed(TcpSocket *socket)
{
...
void TcpSessionFL::socketFailure(TcpSocket *socket, int code)
{
    TcpAppBase::socketFailure(socket, code);
    cancelEvent(timeoutMsg);
}

void TcpSessionFL::parseScript(const char *script)
{
    const char *s = script;
...
void TcpSessionFL::refreshDisplay() const
{
