//
// Generated file, do not edit! Created by nedtool 5.5 from inet/applications/netperfmeter/NetPerfMeter.msg.
//
...
bool NetPerfMeterTransmitTimerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    NetPerfMeterTransmitTimer *pp = (NetPerfMeterTransmitTimer *)object; (void)pp;
    switch (field) {
        case FIELD_streamID: pp->setStreamID(string2ulong(value)); return true;
