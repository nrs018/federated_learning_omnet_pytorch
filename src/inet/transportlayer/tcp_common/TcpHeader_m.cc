//
// Generated file, do not edit! Created by nedtool 5.5 from inet/transportlayer/tcp_common/TcpHeader.msg.
//
...
int TcpHeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'w' && strcmp(fieldName, "window") == 0) return base+13;
    if (fieldName[0] == 'u' && strcmp(fieldName, "urgentPointer") == 0) return base+14;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crc") == 0) return base+15;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crcMode") == 0) return base+16;
    if (fieldName[0] == 'h' && strcmp(fieldName, "headerOption") == 0) return base+17;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
