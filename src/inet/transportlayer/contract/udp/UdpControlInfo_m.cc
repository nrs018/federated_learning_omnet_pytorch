//
// Generated file, do not edit! Created by nedtool 5.5 from inet/transportlayer/contract/udp/UdpControlInfo.msg.
//
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::UdpSetOptionSubcode");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::UdpSetOptionSubcode"));
    e->insert(UDP_C_SETOPTION_TTL, "UDP_C_SETOPTION_TTL");
    e->insert(UDP_C_SETOPTION_DSCP, "UDP_C_SETOPTION_DSCP");
    e->insert(UDP_C_SETOPTION_TOS, "UDP_C_SETOPTION_TOS");
    e->insert(UDP_C_SETOPTION_BROADCAST, "UDP_C_SETOPTION_BROADCAST");
    e->insert(UDP_C_SETOPTION_MCAST_IFACE, "UDP_C_SETOPTION_MCAST_IFACE");
    e->insert(UDP_C_SETOPTION_MCAST_LOOP, "UDP_C_SETOPTION_MCAST_LOOP");
    e->insert(UDP_C_SETOPTION_REUSEADDR, "UDP_C_SETOPTION_REUSEADDR");
    e->insert(UDP_C_SETOPTION_JOIN_MCAST_GRP, "UDP_C_SETOPTION_JOIN_MCAST_GRP");
    e->insert(UDP_C_SETOPTION_LEAVE_MCAST_GRP, "UDP_C_SETOPTION_LEAVE_MCAST_GRP");
    e->insert(UDP_C_SETOPTION_JOIN_MCAST_SRC, "UDP_C_SETOPTION_JOIN_MCAST_SRC");
    e->insert(UDP_C_SETOPTION_BLOCK_MCAST_SRC, "UDP_C_SETOPTION_BLOCK_MCAST_SRC");
    e->insert(UDP_C_SETOPTION_UNBLOCK_MCAST_SRC, "UDP_C_SETOPTION_UNBLOCK_MCAST_SRC");
    e->insert(UDP_C_SETOPTION_LEAVE_MCAST_SRC, "UDP_C_SETOPTION_LEAVE_MCAST_SRC");
    e->insert(UDP_C_SETOPTION_SET_MCAST_SRC_FILTER, "UDP_C_SETOPTION_SET_MCAST_SRC_FILTER");
)
...
inet::UdpSetOptionSubcode UdpSetOptionCommand::getOptionCode() const
{
    return this->optionCode;
}

void UdpSetOptionCommand::setOptionCode(inet::UdpSetOptionSubcode optionCode)
{
...
int UdpSetOptionCommandDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'o' && strcmp(fieldName, "optionCode") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int UdpSetTosCommandDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    UdpSetTosCommand *pp = (UdpSetTosCommand *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *UdpSetTosCommandDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string UdpSetTosCommandDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool UdpSetTosCommandDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *UdpSetTosCommandDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
