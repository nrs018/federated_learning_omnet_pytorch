//
// Generated file, do not edit! Created by nedtool 5.5 from inet/transportlayer/rtp/RtpSenderStatusMessage.msg.
//
...
inet::rtp::RtpSenderStatus RtpSenderStatusMessage::getStatus() const
{
    return this->status;
}

void RtpSenderStatusMessage::setStatus(inet::rtp::RtpSenderStatus status)
{
    this->status = status;
}
