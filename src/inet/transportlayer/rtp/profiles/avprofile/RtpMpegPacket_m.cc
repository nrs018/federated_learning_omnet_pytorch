//
// Generated file, do not edit! Created by nedtool 5.5 from inet/transportlayer/rtp/profiles/avprofile/RtpMpegPacket.msg.
//
...
bool RtpMpegHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    RtpMpegHeader *pp = (RtpMpegHeader *)object; (void)pp;
    switch (field) {
        case FIELD_headerLength: pp->setHeaderLength(string2long(value)); return true;
        case FIELD_payloadLength: pp->setPayloadLength(string2long(value)); return true;
        case FIELD_mbz: pp->setMbz(string2ulong(value)); return true;
        case FIELD_two: pp->setTwo(string2bool(value)); return true;
        case FIELD_temporalReference: pp->setTemporalReference(string2ulong(value)); return true;
        case FIELD_activeN: pp->setActiveN(string2bool(value)); return true;
        case FIELD_newPictureHeader: pp->setNewPictureHeader(string2bool(value)); return true;
        case FIELD_sequenceHeaderPresent: pp->setSequenceHeaderPresent(string2bool(value)); return true;
        case FIELD_beginningOfSlice: pp->setBeginningOfSlice(string2bool(value)); return true;
        case FIELD_endOfSlice: pp->setEndOfSlice(string2bool(value)); return true;
        case FIELD_pictureType: pp->setPictureType(string2ulong(value)); return true;
        case FIELD_fbv: pp->setFbv(string2bool(value)); return true;
        case FIELD_bfc: pp->setBfc(string2ulong(value)); return true;
        case FIELD_ffv: pp->setFfv(string2bool(value)); return true;
        case FIELD_ffc: pp->setFfc(string2ulong(value)); return true;
