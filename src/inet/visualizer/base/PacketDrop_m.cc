//
// Generated file, do not edit! Created by nedtool 5.5 from inet/visualizer/base/PacketDrop.msg.
//
...
unsigned int PacketDropDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISCOMPOUND | FD_ISPOINTER | FD_ISCOBJECT,    // FIELD_networkInterface
...
int PacketDropDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'p' && strcmp(fieldName, "packet_") == 0) return base+0;
    if (fieldName[0] == 'm' && strcmp(fieldName, "module") == 0) return base+1;
    if (fieldName[0] == 'n' && strcmp(fieldName, "networkNode") == 0) return base+2;
    if (fieldName[0] == 'n' && strcmp(fieldName, "networkInterface") == 0) return base+3;
    if (fieldName[0] == 'p' && strcmp(fieldName, "position") == 0) return base+4;
...
const char *PacketDropDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "omnetpp::cObject",    // FIELD_networkInterface
...
int PacketDropDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketDrop *pp = (PacketDrop *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *PacketDropDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketDrop *pp = (PacketDrop *)object; (void)pp;
    switch (field) {
        case FIELD_packet_: { const cPacket * value = pp->getPacket_(); return omnetpp::opp_typename(typeid(*value)); }
        case FIELD_module: { const cModule * value = pp->getModule(); return omnetpp::opp_typename(typeid(*value)); }
        case FIELD_networkNode: { const cModule * value = pp->getNetworkNode(); return omnetpp::opp_typename(typeid(*value)); }
        case FIELD_networkInterface: { const cObject * value = pp->getNetworkInterface(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}

std::string PacketDropDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketDrop *pp = (PacketDrop *)object; (void)pp;
    switch (field) {
        case FIELD_packet_: {std::stringstream out; out << pp->getPacket_(); return out.str();}
        case FIELD_module: {std::stringstream out; out << pp->getModule(); return out.str();}
        case FIELD_networkNode: {std::stringstream out; out << pp->getNetworkNode(); return out.str();}
        case FIELD_networkInterface: {std::stringstream out; out << pp->getNetworkInterface(); return out.str();}
        case FIELD_position: {std::stringstream out; out << pp->getPosition(); return out.str();}
        default: return "";
    }
}

bool PacketDropDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *PacketDropDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case FIELD_packet_: return omnetpp::opp_typename(typeid(cPacket));
        case FIELD_module: return omnetpp::opp_typename(typeid(cModule));
        case FIELD_networkNode: return omnetpp::opp_typename(typeid(cModule));
        case FIELD_networkInterface: return omnetpp::opp_typename(typeid(cObject));
        case FIELD_position: return omnetpp::opp_typename(typeid(Coord));
        default: return nullptr;
    };
}

void *PacketDropDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketDrop *pp = (PacketDrop *)object; (void)pp;
    switch (field) {
        case FIELD_packet_: return toVoidPtr(pp->getPacket_()); break;
        case FIELD_module: return toVoidPtr(pp->getModule()); break;
        case FIELD_networkNode: return toVoidPtr(pp->getNetworkNode()); break;
        case FIELD_networkInterface: return toVoidPtr(pp->getNetworkInterface()); break;
