//
// Generated file, do not edit! Created by nedtool 5.5 from inet/queueing/common/LabelsTag.msg.
//
...
unsigned int LabelsTagDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_labels
    };
...
bool LabelsTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    LabelsTag *pp = (LabelsTag *)object; (void)pp;
    switch (field) {
        case FIELD_labels: pp->setLabels(i,(value)); return true;
